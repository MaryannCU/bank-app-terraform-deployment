# // Consolidated variables (duplicates removed). If any defaults need to be changed,
# // tell me which values you prefer and I'll update them.
...
#   type        = string
#   default     = "44.198.157.70" # Replace with your actual client IP
# }
